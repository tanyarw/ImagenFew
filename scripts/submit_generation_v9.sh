#!/bin/bash
#SBATCH --job-name=gen_v9_holdout
...
echo "Clean v9 Synthetic Generation (Holdout Split 2000–2007, seq_len = 36)"
echo "Run ID:        $RUN_ID"
echo "Years:         $YEARS | Freq: 5min | Seed: $SEED | Mode: $MODE"
echo "Start Time:    $(date)"
echo "=========================================================="

bash scripts/run_v9_generation.sh "$RUN_ID" "$YEARS" "$SEED" "$MODE"

echo ""
echo "=========================================================="
echo "Generation complete! Output files in results/generated_data/:"
ls -lh results/generated_data/rainfall_synthetic_10y_v9*.csv
echo "End Time: $(date)"
echo "=========================================================="
