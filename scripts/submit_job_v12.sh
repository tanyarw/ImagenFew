#!/bin/bash
#SBATCH --job-name=v12_len64_uncond_finetune
...
# Train clean v12 unconditional ablation (seq_len=64, ImagenFew_64.ckpt) for 500 epochs with run_id 'v12'
bash scripts/run_v12_training.sh 500 v12
