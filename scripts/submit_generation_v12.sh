...
echo "Clean v12 Synthetic Generation (Holdout Split 2000–2007, seq_len = 64, Unconditional)"
echo "Run ID:        $RUN_ID"
...
ls -lh results/generated_data/rainfall_synthetic_10y_v12.csv
echo "End Time: $(date)"
echo "=========================================================="
