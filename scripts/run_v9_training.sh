#!/usr/bin/env bash
# ==============================================================================
# Clean v9 Training Pipeline (Strict Holdout 2000–2007, seq_len = 144)
# ==============================================================================
# Fine-tunes ImagenFew (v9) on the clean 2000–2007 seasonal-phase training dataset
# with sequence length 144 (12h block).
#
# Usage:
...
echo "═══════════════════════════════════════════════════════════"
echo "  Starting Clean v9 Training Pipeline (seq_len = 144)"
echo "═══════════════════════════════════════════════════════════"
...
echo "  Sequence Length : 144 (12 hours)"
echo "  Epochs          : ${EPOCHS}"
