#!/usr/bin/env bash
# ==============================================================================
# Clean v10 Training Pipeline (Strict Holdout 2000–2007, seq_len = 64)
# ==============================================================================
# Fine-tunes ImagenFew (v10) on the clean 2000–2007 seasonal-phase training dataset
# with sequence length 64 (5.33h block).
#
# Usage:
...
echo "═══════════════════════════════════════════════════════════"
echo "  Starting Clean v10 Training Pipeline (seq_len = 64)"
echo "═══════════════════════════════════════════════════════════"
