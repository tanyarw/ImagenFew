#!/bin/bash
#SBATCH --job-name=gen_e1_v8ckpt64
...
echo "E1 Control Run B Synthetic Generation (seq_len = 24, ImagenFew_64.ckpt init)"
echo "Run ID:        $RUN_ID"
...
bash scripts/run_e1_v8ckpt64_generation.sh "$RUN_ID" "$YEARS" "$SEED" "$MODE"

echo ""
echo "=========================================================="
echo "Generation complete! Output files in results/generated_data/:"
ls -lh results/generated_data/rainfall_synthetic_10y_e1_v8ckpt64*.csv
echo "End Time: $(date)"
echo "=========================================================="
