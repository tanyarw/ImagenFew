#!/bin/bash
#SBATCH --job-name=e1_v10ckpt24_finetune
...
# instead of ImagenFew_64.ckpt. See code_plan/AUDIT_2026-09-22.md §3.1 / §6 E1.
bash scripts/run_e1_v10ckpt24_training.sh 500
